...
var Grid = (function () {
  ...
  Grid.prototype.set = function set(x, y, value) {
    ...
    if ([_constants.DEAD, _constants.ALIVE].indexOf(value) === -1) {
      throw new Error('Value must be ' + _constants.DEAD + ' or ' + _constants.ALIVE);
    }
  ...
  Grid.prototype.numberOfLiveNeighbors = function numberOfLiveNeighbors(x, y) {
    if (x < 0 || x >= this.width || y < 0 || y >= this.height) {
      throw new Error('Coordinates out of bounds: ' + x + ', ' + y);
    }
