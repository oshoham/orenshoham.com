...
get '/itp-portfolio' do
  ...
  recreating_the_past_sketches = [
    ...
    { order: 9, file_name: 'whitney_1', source_url: 'https://github.com/oshoham/sfpc__recreating-the-past/blob/master/week-2/homework/whitney/src/ofApp.cpp', description: "Recreation of a scene from John Whitney's film Arabesque.", type: 'openframeworks' },
    { order: 8, file_name: 'whitney_2', source_url: 'https://github.com/oshoham/sfpc__recreating-the-past/blob/master/week-9/digital-harmony-arabesque/src/ofApp.cpp', description: "Recreation of a scene from John Whitney's film Arabesque", type: 'openframeworks' },
