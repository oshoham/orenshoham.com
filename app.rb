...
get '/itp-portfolio' do
  sketches = [
    ...
    { order: 24, file_name: 'osamu_sato', source_url: 'https://github.com/oshoham/code-sketches/blob/master/art-of-computer-designing/ch-1/step-2-lesson-3-crystal/sketch.js', description: "Animation of a design from Osamu Sato's book The Art of Computer Designing.", type: 'p5' },
    ...
    { order: 2, file_name: 'sol_lewitt_1', source_url: 'https://github.com/oshoham/code-sketches/blob/master/sol-lewitt-wall-drawing-118/sketch.js', description: "Animation of Sol LeWitt's Wall Drawing 118.", type: 'p5' },
    { order: 1, file_name: 'sol_lewitt_2', source_url: 'https://github.com/oshoham/code-sketches/blob/master/sol-lewitt-wall-drawing-138/sketch.js', description: "Animation of Sol LeWitt's Wall Drawing 138.", type: 'p5' },
    { order: 0, file_name: 'sol_lewitt_3', source_url: 'https://github.com/oshoham/code-sketches/blob/master/sol-lewitt-wall-drawing-91/sketch.js', description: "Animation of Sol LeWitt's Wall Drawing 91.", type: 'p5' },
    ...
    { order: 26, file_name: 'vera_molnar_1', source_url: 'https://github.com/oshoham/sfpc__recreating-the-past/blob/master/week-1/homework/vera-molnar-molndrian-1974-recreation-animated/sketch.js', description: "Animation of Vera Molnar's Molndrian.", type: 'p5' },
    { order: 25, file_name: 'vera_molnar_2', source_url: 'https://github.com/oshoham/sfpc__recreating-the-past/blob/master/week-1/homework/vera-molnar-hommage-a-durer-recreation-animated/sketch.js', description: "Animation of Vera Molnar's Hommage à Dürer.", type: 'p5' },
    ...
    { order: 23, file_name: 'whitney_1', source_url: 'https://github.com/oshoham/sfpc__recreating-the-past/blob/master/week-2/homework/whitney/src/ofApp.cpp', description: "Recreation of a scene from John Whitney's film Arabesque.", type: 'openframeworks' },
    { order: 7, file_name: 'whitney_2', source_url: 'https://github.com/oshoham/sfpc__recreating-the-past/blob/master/week-9/digital-harmony-arabesque/src/ofApp.cpp', description: "Recreation of a scene from John Whitney's film Arabesque", type: 'openframeworks' },
    { order: 4, file_name: 'whitney_3', source_url: 'https://github.com/oshoham/code-sketches/blob/master/whitney-digital-harmony/src/ofApp.cpp', description: "Animation of the cover of John Whitney's book Digital Harmony.", type: 'openframeworks' }
  ]
  erb :itp_portfolio, locals: { sketches: sketches.sort_by { |s| s[:order] }.reverse }
end
